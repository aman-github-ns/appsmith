...
export const BASE_URL = "/forms/";
export const WORKSPACE_URL = "/forms/workspace";
export const PAGE_NOT_FOUND_URL = "/forms/404";
export const SERVER_ERROR_URL = "/forms/500";
export const APPLICATIONS_URL = `/forms/applications`;
...
export const WORKSPACE_SETTINGS_LICENSE_PAGE_URL = `/forms/settings/license`;
